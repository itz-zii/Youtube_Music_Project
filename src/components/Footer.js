function Footer() {
    return `
    <footer class="bg-[#211e1e] z-100 bottom-0 left-0 h-20 w-full rounded-b-xl fixed flex flex-col justify-between">
        ...
        <div class="flex items-center justify-between px-5 h-full">
            ...
            <div id="footer-track-info" class="flex items-center gap-3 text-white">

                <img id="footer-track-img" 
                     src="" 
                     class="w-14 h-14 rounded-md object-cover hidden">

                <div class="flex flex-col">
                    <span id="footer-track-name" class="font-semibold text-sm"></span>
                    <span id="footer-track-artist" class="text-gray-300 text-xs"></span>
                </div>
            </div>
            ...
            <div class="flex items-center gap-3 mx-5">
                ...
                <input id="volume-slider" type="range" min="0" max="1" step="0.01"
                    class="w-32 h-1 bg-gray-300 rounded-lg cursor-pointer accent-transparent">
            </div>
        </div>
